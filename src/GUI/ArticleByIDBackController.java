 ...
 * @author mazee
 */
public class ArticleByIDBackController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        List<String> badWords = Arrays.asList("bhim", "badword","bad");
...
contentStream.setFont(PDType0Font.load(document, new File("c:/windows/fonts/Helvetica.ttf")), 12);
            ...
            contentStream.setLeading(18.5f);  // set the size of the newline to something reasonable
...
private void handleaddComment(ActionEvent event) {
    try {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("AddCommentBack.FXML"));
        Parent root = loader.load();
        AddCommentBackController addCommentController = loader.getController();
...
private void handledeleteComment(ActionEvent event) {
    try {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("deleteCommentBack.FXML"));
        Parent root = loader.load();
        DeleteCommentBackController deleteCommentController = loader.getController();
