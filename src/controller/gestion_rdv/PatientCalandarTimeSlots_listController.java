...
//    private Button btn_calandarGo;
    ...
    void onActionBook(ActionEvent event) {
        ...
        if (confirmAlert.getResult() == ButtonType.APPLY) {
            ...
            try {
                ...
                if (crudAppointment.Insert_AddAppointment_Requires_atMinimum_TimeSlot_and_Patient_Id(newAppointment, timeSlot_id, patient_id)) {
                    ...
                    MyLabelUtil.labelmsg_collabsable_bold_textVisibleGreen(label_msg);
                    ...
                    MyLabelUtil.labelmsg_collabsable_bold_textVisibleRed(label_msg);
                    label_msg.setText("refresh and try again appointment  not added .");
                }
        ...
        //clear label
        MyLabelUtil.hideLabelAfter(label_msg, 3);
    }
